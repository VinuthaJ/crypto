...
def  eprocess(request):
    ...
    imgpath=r"/home/abhinav/Documents/DjangoProjects/cryptography/mini/static/mini/images/" + img
    ...
    sp=r"/home/abhinav/Documents/"+ ename
...
def dprocess(request):
    ...
    #loading the image
    img=request.GET.get('png','none')
    image=r"/home/abhinav/Documents/" + img
    im=Image.open(image)
